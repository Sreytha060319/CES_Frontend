        ...
        <ul class="space-y-2">
          ...
          <li>
            <router-link to="/admin/home"
              ...
              :class="{ 'justify-center': !showSide }" active-class=" text-white">
          ...
          <li>
            ...
            <transition name="slide">
              <ul v-if="productsDropdownOpen && showSide"
                ...
                <!-- <li>
                  <router-link to="/admin/products/details"
                    class="block py-2 text-orange-900 hover:text-orange-700 transition-colors"
                    active-class="text-orange-600 font-medium">
                    Details
                  </router-link>
                </li> -->
          ...
          <li>
            <button @click="toggleOrderDropdown"
              ...
              <span v-if="showSide" class="flex-1 ml-3 font-bold text-left">Orders</span>
              <span v-if="showSide" class="transform transition-transform duration-200"
            ...
            <transition name="slide">
              <ul v-if="orderDropdownOpen && showSide"
                class="ml-2 mt-1 space-y-1 pl-8 border-l-2 border-orange-400">
                <li>
                  <router-link to="/admin/order/orderList"
                    class="block py-2 text-white  transition-colors"
                    active-class="text-orange-600 font-medium">
                    List
                  </router-link>
         ...
         <li>
            <button @click="toggleCategoryDropdown"
              ...
              <span v-if="showSide" class="flex-1 ml-3 font-bold text-left">Category</span>
              <span v-if="showSide" class="transform transition-transform duration-200"
                :class="{ 'rotate-90': categoryDropdownOpen }">
                <i class="fas fa-chevron-right text-xs"></i>
              </span>
            </button>

            <transition name="slide">
              <ul v-if="categoryDropdownOpen && showSide"
                class="ml-2 mt-1 space-y-1 pl-8 border-l-2 border-orange-400">
                <li>
                  <router-link to="/admin/categorys/categorylist"
                    class="block py-2 text-white  transition-colors"
                    active-class="text-orange-600 font-medium">
                   Category List
                  </router-link>
...
<li>
  ...
  >
    ...
    <span v-if="showSide" class="ml-3 font-bold">Calendar</span>
        ...
        <li>
            <button @click="toggleSellerDropdown"
              class="flex items-center w-full p-3 rounded-lg text-white   transition-colors"
              :class="{ 'justify-center': !showSide }">
              <i class="fas fa-user-tie text-xl w-6 text-center"></i>
              <span v-if="showSide" class="flex-1 ml-3 font-bold text-left">Seller</span>
              <span v-if="showSide" class="transform transition-transform duration-200"
                :class="{ 'rotate-90': sellerDropdownOpen }">
                <i class="fas fa-chevron-right text-xs"></i>
              </span>
            </button>

            <transition name="slide">
              <ul v-if="sellerDropdownOpen && showSide"
                class="ml-2 mt-1 space-y-1 pl-8 border-l-2 border-orange-400"> 
                <li>
                  <router-link to="/admin/seller/sellerlist"
                    class="block py-2 text-white  transition-colors"
                    active-class="text-orange-600 font-medium">
                     Seller List
                  </router-link>
            ...
            <router-link to="/admin/user"
              ...
              <span v-if="showSide" class="ml-3 font-bold">User</span>
            </router-link>
          </li>
          <li>
            <router-link to="/admin/settings"
              class="flex items-center p-3 rounded-lg text-white  transition-colors"
              :class="{ 'justify-center': !showSide }" active-class="bg-orange-300 text-white">
            ...
            <div class="relative">
              ...
              <transition name="fade">
                <div v-show="showDropDown"
                  ...
                  <div class="py-1">
                    <a he="#"
                      class="block px-4 py-2 text-sm text-black hover:bg-pink-600">Account Settings</a>
                    <a href="#"
                      class="block px-4 py-2 text-sm text-black hover:bg-pink-600">Support</a>
                    <button @click="logout"
