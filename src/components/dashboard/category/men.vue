      ...
      >
        ...
        <main class="container mx-auto px-4 py-8">
            <section class="text-center mb-12">
                <h1 class="men-collection text-3xl md:text-4xl font-bold mb-3">MEN COLLECTION</h1>
...
export default {
    ...
    data() {
        return {
            products: [
                { id: 1, name: 'Knitting Button Short Tops Tees Patchwork Y2k Shirt', price: '$13.50', image: '/images/M01.png' },
                { id: 2, name: 'Elegant Summer Dress Floral Pattern Light Fabric', price: '$22.00', image: '/images/M02.png' },
                { id: 3, name: 'Casual Denim Jacket with Vintage Wash Details', price: '$35.90', image: '/images/M03.png' },
                { id: 4, name: 'High-Waisted Skinny Jeans Stretch Fabric', price: '$29.99', image: '/images/M04.png' },
                { id: 5, name: 'Cozy Knit Sweater Soft Wool Blend Oversized', price: '$45.00', image: '/images/M05.png' },
                { id: 6, name: 'Striped Long Sleeve T-Shirt Cotton Comfortable', price: '$18.75', image: '/images/M06.png' },
                { id: 7, name: 'Sporty Athleisure Hoodie with Drawstring', price: '$33.20', image: '/images/M07.png' },
                { id: 8, name: 'Bohemian Style Maxi Skirt Flowy and Light', price: '$27.50', image: '/images/M08.png' },
            ],
